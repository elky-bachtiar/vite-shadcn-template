 ...
 */
export async function seedStripeProducts(providedCampaigns) {
 ...
 */
async function processCampaign(campaign, results) {
 ...
 */
async function createPriceTariffs(campaignId, productId, results) {
